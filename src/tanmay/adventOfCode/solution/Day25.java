...
/**
 * Created by tanmaymehra on 12/24/16.
 */
public class Day25 {

    public static void main(String[] args) throws FileNotFoundException {
        File file = new File("/Users/tanmaymehra/Documents/demo49/JavaPractice/src/tanmay/adventOfCode/solution/day25.txt");
            ...
            while (j < 30) {
                ...
                if (cmd.contains("cpy")) {
                    ...
                    try {
                        ...
                        if (sp[1].equals("a")) {
                            l = a;
                        } else if (sp[1].equals("b")) {
                            l = b;
                        } else if (sp[1].equals("c")) {
                            l = c;
